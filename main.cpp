...
template <typename T> void insertionsort(T ary[], size_t low, size_t high) {
...
template <typename T> size_t partition(T ary[], size_t low, size_t high) {
...
template <typename T> size_t randPartition(T ary[], size_t low, size_t high) {
